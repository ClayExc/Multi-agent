...
| S2-RUNTIME | [SC-S2-RUNTIME-v2](./S2-RUNTIME.md) | WP-123/125 | ACTIVE_WP123 |
| S3-PLATFORM | [SC-S3-PLATFORM-v2](./S3-PLATFORM.md) | WP-122 | COMPLETED |
...
WP-122 已完成，当前只有 S2/WP-123 获得写租约，其余角色等待精确线性 Head。
ContractSet 候选摘要为
