...
class PolicyErrorCode(StrEnum):
    ...
    BUNDLE_UNTRUSTED = "PLATFORM_POLICY_BUNDLE_UNTRUSTED"
    VERSION_CONFLICT = "PLATFORM_POLICY_VERSION_CONFLICT"
    VERSION_REVOKED = "PLATFORM_POLICY_VERSION_REVOKED"
    EVALUATION_FAILED = "PLATFORM_POLICY_EVALUATION_FAILED"
