...
class PersistenceErrorCode(StrEnum):
    ...
    SECURITY_CONTEXT_REQUIRED = "DATA_SECURITY_CONTEXT_REQUIRED"
    SECURITY_CONTEXT_MISMATCH = "DATA_SECURITY_CONTEXT_MISMATCH"
    SECURITY_CONTEXT_UNTRUSTED = "DATA_SECURITY_CONTEXT_UNTRUSTED"
    UNSAFE_DATABASE_ROLE = "DATA_UNSAFE_DATABASE_ROLE"
