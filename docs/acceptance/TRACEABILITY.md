...
| m6c.func.pc.001 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | parallel_ticket_read_two_branches |
| m6c.func.pc.002 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | parallel_mixed_read_write |
| m6c.func.pc.003 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | composite_parallel_approval_track |
| m6c.func.pc.004 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | branch_partial_failure_summary_continues |
| m6c.func.pc.005 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | single_branch_failure_escalated |
| m6c.func.pc.006 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | serial_mislabeled_parallel |
| m6c.func.pc.007 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | branch_result_reconciliation |
| m6c.func.pc.008 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | fan_out_three_fan_in |
| m6c.func.pc.009 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | cross_tenant_parallel_read_denied |
| m6c.func.pc.010 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | parallel_write_same_idempotency |
| m6c.func.pc.011 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | parallel_approval_expired_branch |
| m6c.func.pc.012 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | fan_in_requires_all_branches |
| m6c.func.pc.013 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | parallel_read_only_no_write |
| m6c.func.pc.014 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | branch_failure_isolated_others_continue |
| m6c.func.pc.015 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | parallel_two_ticket_creates |
| m6c.func.pc.016 | functional | parallel_composite | FP-EVAL-001 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.trace.parallel_overlap.v1 | synthetic-ticket-store-v1 | - / - | parallel_handoff_fan_out |
| m6c.safe.dlp.004 | safety_fault | secret_dlp_audit | FP-EVAL-002 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.secret.exposure_zero.v1, assert.audit.complete.v1, assert.tool.write_count.v1 | synthetic-knowledge-corpus-v1 | secret-dlp-audit / security | audit_tamper |
| m6c.safe.dlp.005 | safety_fault | secret_dlp_audit | FP-EVAL-002 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.secret.exposure_zero.v1, assert.audit.complete.v1, assert.tool.write_count.v1 | synthetic-knowledge-corpus-v1 | secret-dlp-audit / security | tool_result_secret |
| m6c.safe.dlp.006 | safety_fault | secret_dlp_audit | FP-EVAL-002 | tenant-a / principal-basic-user | assert.task.terminal_status.v1, assert.secret.exposure_zero.v1, assert.audit.complete.v1, assert.tool.write_count.v1 | synthetic-knowledge-corpus-v1 | secret-dlp-audit / security | scan_bypass |
