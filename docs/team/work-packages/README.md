...
| [WP-122](./WP-122-m11-memory-security-surface.md) | S3-PLATFORM | DONE | WP-121 | Working Memory 集中内容安全表面 |
| [WP-123](./WP-123-m11-context-memory-core.md) | S2-RUNTIME | ACTIVE | WP-122 | Turn/Snapshot/Manifest、摘要与预算核心 |
...
WP-122 已完成，当前只有 S2/WP-123 获得写租约。
