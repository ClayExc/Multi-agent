...
class ErrorCode(StrEnum):
    ...
    GOVERNANCE_CURSOR_INVALID = "CORE_GOVERNANCE_CURSOR_INVALID"
    GOVERNANCE_NOT_FOUND = "CORE_GOVERNANCE_NOT_FOUND"
    GOVERNANCE_REPOSITORY_UNAVAILABLE = "CORE_GOVERNANCE_REPOSITORY_UNAVAILABLE"
    GOVERNANCE_REPOSITORY_PROTOCOL_ERROR = "CORE_GOVERNANCE_REPOSITORY_PROTOCOL_ERROR"
    GOVERNANCE_UNSAFE_PROJECTION = "CORE_GOVERNANCE_UNSAFE_PROJECTION"
    KNOWLEDGE_CONTRACT_INVALID = "CORE_KNOWLEDGE_CONTRACT_INVALID"
    KNOWLEDGE_CONTENT_UNSAFE = "CORE_KNOWLEDGE_CONTENT_UNSAFE"
    KNOWLEDGE_AUTHORIZATION_DENIED = "CORE_KNOWLEDGE_AUTHORIZATION_DENIED"
    KNOWLEDGE_AUTHORIZATION_UNAVAILABLE = "CORE_KNOWLEDGE_AUTHORIZATION_UNAVAILABLE"
    KNOWLEDGE_AUTHORIZATION_PROTOCOL_ERROR = (
        "CORE_KNOWLEDGE_AUTHORIZATION_PROTOCOL_ERROR"
    )
    KNOWLEDGE_IDEMPOTENCY_CONFLICT = "CORE_KNOWLEDGE_IDEMPOTENCY_CONFLICT"
    KNOWLEDGE_NOT_FOUND = "CORE_KNOWLEDGE_NOT_FOUND"
    KNOWLEDGE_ALREADY_EXISTS = "CORE_KNOWLEDGE_ALREADY_EXISTS"
    KNOWLEDGE_VERSION_CONFLICT = "CORE_KNOWLEDGE_VERSION_CONFLICT"
    KNOWLEDGE_LIFECYCLE_CONFLICT = "CORE_KNOWLEDGE_LIFECYCLE_CONFLICT"
    KNOWLEDGE_TENANT_MISMATCH = "CORE_KNOWLEDGE_TENANT_MISMATCH"
    KNOWLEDGE_PURPOSE_DENIED = "CORE_KNOWLEDGE_PURPOSE_DENIED"
    KNOWLEDGE_CLASSIFICATION_DENIED = "CORE_KNOWLEDGE_CLASSIFICATION_DENIED"
    KNOWLEDGE_REFERENCE_MISMATCH = "CORE_KNOWLEDGE_REFERENCE_MISMATCH"
    KNOWLEDGE_REFERENCE_UNAVAILABLE = "CORE_KNOWLEDGE_REFERENCE_UNAVAILABLE"
    KNOWLEDGE_CONTENT_PROJECTION_UNAVAILABLE = (
        "CORE_KNOWLEDGE_CONTENT_PROJECTION_UNAVAILABLE"
    )
    KNOWLEDGE_CONTENT_PROJECTION_PROTOCOL_ERROR = (
        "CORE_KNOWLEDGE_CONTENT_PROJECTION_PROTOCOL_ERROR"
    )
    KNOWLEDGE_REPOSITORY_UNAVAILABLE = "CORE_KNOWLEDGE_REPOSITORY_UNAVAILABLE"
    KNOWLEDGE_REPOSITORY_PROTOCOL_ERROR = "CORE_KNOWLEDGE_REPOSITORY_PROTOCOL_ERROR"
