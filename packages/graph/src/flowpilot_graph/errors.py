...
class GraphErrorCode(StrEnum):
    ...
    GRAPH_FACTORY_DIVERGED = "GRAPH_FACTORY_DIVERGED"
    BUDGET_EXHAUSTED = "GRAPH_BUDGET_EXHAUSTED"
    HANDOFF_DENIED = "GRAPH_HANDOFF_DENIED"
    DEBUG_PROJECTION_UNSAFE = "GRAPH_DEBUG_PROJECTION_UNSAFE"
    STUDIO_PROFILE_FORBIDDEN = "GRAPH_STUDIO_PROFILE_FORBIDDEN"
    STUDIO_STATE_EDIT_FORBIDDEN = "GRAPH_STUDIO_STATE_EDIT_FORBIDDEN"
